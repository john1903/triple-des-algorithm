...
class KeyManagerTest {
    ...
    void generateKeys() {
        try {
            keyManager.write("src/test/java/me/jangluzniewicz/tripledes/managers/keys_copy.txt");
        } catch (Exception e) {
            throw new RuntimeException("Error generating keys: " + e.getMessage());
        }
        byte[][] key;
        try {
            key = keyManager.read("src/test/java/me/jangluzniewicz/tripledes/managers/keys_copy.txt");
        } catch (Exception e) {
        ...
        File fileCopy = new File("src/test/java/me/jangluzniewicz/tripledes/managers/keys_copy.txt");
        if (fileCopy.exists()) {
    ...
    void readKeys() {
        byte[][] key;
        try {
            key = keyManager.read("src/test/java/me/jangluzniewicz/tripledes/managers/keys.txt");
        } catch (Exception e) {
